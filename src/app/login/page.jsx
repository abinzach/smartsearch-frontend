...
const Login = () => {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      await logIn(); // Log in using the provided logIn function
          ...
          <div className='max-w-[450px] h-[350px] mx-auto my-48 md:my-20  rounded-lg bg-gray-300/20 shadow-md backdrop-blur-sm text-white'>
            <div className='max-w-[320px] mx-auto py-16'>
              ...
              >
                ...
                <div className='flex items-center justify-center gap-5'><span><FaGoogle/></span> <span>Sign in with Google</span></div>
                </button>
                ...
                <p className='py-8'>
                  ...
                  <span className='text-gray-300 text-sm'>
                    Not a Smart Search user?
                  </span>{' '}
                  <Link className="hover:text-red-400 text-white text-sm transition-all duration-500" href='/signup'>Sign Up</Link>
                </p>
              </form>
            </div>
          </div>
